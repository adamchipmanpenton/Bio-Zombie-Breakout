...
function youWin(){
    console.log("you win")
    document.getElementById("textArea").value ="You were able to answer all the questions and escape to safety. I just hope you don't turn in to one later."
    hideAnswers()
    clearInterval(myVar)
    document.getElementById('next_question').style.display = "none";
    document.getElementById('playAgain').style.display = "";
    $("#playAgain").removeEventListener("click", playAgain())
...
function startGame(){
    ...
    doorNumberCounter = 1
    displayZombieDistance();
    myVar = setInterval(countDown, 10)
}


function displayZombieDistance (){
    if (distanceCounter == 0){
        document.getElementById("textArea").value = "Someone in the research laboratory you are working in spilt a vial of chemicals. People have "+
	    ...
	    document.getElementById("textArea").value = "The only noise you hear is the alarms. You must move quickly before the zombies find you."
        document.getElementById('health').src = "images/Health 2.jpg";
        
        
    }else if(distanceCounter == 2){
	    document.getElementById("textArea").value = "It is too late, you start to hear noise in the distance. Something is approaching."
        document.getElementById('health').src = "images/Health 3.jpg";
        
         
    }else if(distanceCounter == 3){
	    document.getElementById("textArea").value = "You see a large group of zombies starting to come down the hallway towards you."
        ...
        document.getElementById("textArea").value ="You could not get out in time. A group of zombies have surrounded you and you are bitten. You slowly turn into a zombie."
        hideAnswers()
        document.getElementById('next_question').style.display = "none";
        document.getElementById('playAgain').style.display = "";
        playAgain()
...
function countDown(){
    ...
    if (seconds == 60){
        ...
        document.getElementById("textArea").value = "You ran out of time!!"
        hideAnswers()
        document.getElementById('next_question').style.display = "none";
        document.getElementById('playAgain').style.display = "";
...
//document.getElementById("answer1").removeEventListener("click")
